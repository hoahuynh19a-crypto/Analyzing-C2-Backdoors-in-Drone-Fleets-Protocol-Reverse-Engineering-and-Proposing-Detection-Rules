...
MalwareBazaar](phan1_image1.png){#fig:p1_1 width="90%"}
...
ELF](phan1_image2.png){#fig:p1_2 width="90%"}

![VirusTotal --- 36 vendor phát hiện mẫu là malicious/Mirai
variant](phan1_image3.png){#fig:p1_3 width="90%"}

![VirusTotal --- Danh sách engine AV và tên
detection](phan1_image4.png){#fig:p1_4 width="90%"}
...
api.snapcraft.io](phan1_image5.png){#fig:p1_5 width="90%"}
...
quan](phan1_image6.png){#fig:p1_6 width="90%"}

![VirusTotal Details --- hash, metadata và lịch sử tên file của
mẫu](phan1_image7.png){#fig:p1_7 width="90%"}

![Hybrid Analysis --- Threat Score 100/100 và malicious
classification](phan1_image8.png){#fig:p1_8 width="90%"}
...
stripped](phan1_image9.png){#fig:p1_9 width="90%"}

![Sơ đồ cấu trúc ELF --- ELF header, program header table và section
headers](phan1_image10.png){#fig:p1_10 width="90%"}

![readelf -h --- Xác nhận ELF32 i386 và entry point
0x08048164](phan1_image11.png){#fig:p1_11 width="90%"}
...
ELF](phan1_image12.png){#fig:p1_12 width="90%"}

![readelf -l --- Program headers, entry point và section-to-segment
mapping](phan1_image13.png){#fig:p1_13 width="90%"}
...
ELF](phan1_image14.png){#fig:p1_14 width="90%"}
...
packed toàn cục](phan1_image15.png){#fig:p1_15 width="90%"}
...
Linux](phan2_image1.png){#fig:p2_1 width="90%"}
...
REMnux](phan2_image2.png){#fig:p2_2 width="90%"}

![Cấu hình VMware LAN Segment cho máy Kali trong mạng
Mirai_Isolated_Net](phan2_image3.png){#fig:p2_3 width="90%"}

![Cấu hình VMware LAN Segment cho máy REMnux và cài
Wireshark/tshark](phan2_image4.png){#fig:p2_4 width="90%"}

![REMnux --- Đặt IP tĩnh 10.10.10.10/24 và tắt
systemd-resolved](phan2_image5.png){#fig:p2_5 width="90%"}
...
/etc/inetsim/inetsim.conf](phan2_image6.png){#fig:p2_6 width="90%"}

![INetSim --- cấu hình dns_default_ip trả về
10.10.10.10](phan2_image7.png){#fig:p2_7 width="90%"}

![INetSim --- kiểm tra service_bind_address và dns_default_ip sau khi
chỉnh cấu hình](phan2_image8.png){#fig:p2_8 width="90%"}

![Kali --- Đặt IP 10.10.10.20/24 và trỏ DNS về
REMnux](phan2_image9.png){#fig:p2_9 width="90%"}

![Kali --- cấu hình iptables DNAT DNS/TCP và kiểm tra bảng
NAT](phan2_image10.png){#fig:p2_10 width="90%"}
...
gói DNS](phan2_image11.png){#fig:p2_11 width="90%"}

![Kali --- ping 8.8.8.8 packet loss 100%, xác nhận môi trường cô
lập](phan2_image12.png){#fig:p2_12 width="90%"}

![REMnux --- ping Kali 10.10.10.20 thành
công](phan2_image13.png){#fig:p2_13 width="90%"}

![INetSim --- khởi động dịch vụ giả lập dns/http/https thành
công](phan2_image14.png){#fig:p2_14 width="90%"}

![tcpdump --- bắt đầu capture trên interface ens33 vào
mirai_capture.pcap](phan2_image15.png){#fig:p2_15 width="90%"}

### Kiểm chứng kết nối và cô lập

![Giải nén mẫu malware bằng 7z với mật khẩu
infected](phan2_image16.png){#fig:p2_16 width="90%"}

![Lệnh file --- xác nhận ELF 32-bit LSB executable, Intel 80386,
statically linked, stripped](phan2_image17.png){#fig:p2_17 width="90%"}

![chmod +x --- cấp quyền thực thi cho mẫu
ELF](phan2_image18.png){#fig:p2_18 width="90%"}
...
commenced"](phan2_image19.png){#fig:p2_19 width="90%"}

![Dừng các tiến trình malware bằng kill -9 theo
PID](phan2_image20.png){#fig:p2_20 width="90%"}

### Giải nén và xác nhận mẫu mã độc trên Kali

![tcpdump --- dừng capture và thu được 1,569
packet](phan2_image21.png){#fig:p2_21 width="90%"}

![INetSim --- dừng simulation và ghi
report.3756.txt](phan2_image22.png){#fig:p2_22 width="90%"}

### Thực thi mã độc với strace

![Kiểm tra strace log --- 4,439 dòng, file mirai_strace.log 384
KB](phan2_image23.png){#fig:p2_23 width="90%"}

![SHA256 --- hash của artifact
mirai_strace.log](phan2_image24.png){#fig:p2_24 width="90%"}
...
213](phan2_image25.png){#fig:p2_25 width="90%"}

![capinfos --- tổng quan file mirai_capture.pcap, 1,569 packet, 219
KB](phan2_image26.png){#fig:p2_26 width="90%"}

![tshark Protocol Hierarchy --- TCP 840 frames, UDP/DNS 589
frames](phan2_image27.png){#fig:p2_27 width="90%"}
...
10.10.10.10](phan2_image28.png){#fig:p2_28 width="90%"}
...
nhận](phan2_image35.png){#fig:p2_35 width="90%"}
...
0x08048164](phan3_image1.png){#fig:p3_1 width="90%"}

![Ghidra --- rename FUN_08050b25 thành main](phan3_image2.png){#fig:p3_2
width="90%"}

![Ghidra --- rename hàm tại 0x0804a8f4 thành
http_flood_sender](phan3_image3.png){#fig:p3_3 width="90%"}

![Ghidra --- rename hàm tại 0x08051a62 thành
rc4_like_decoder_candidate](phan3_image4.png){#fig:p3_4 width="90%"}

## Strings và HTTP Path Analysis

![XOR helper --- chạy khiem_xor_decoder.py với single byte
0x22](phan3_image5.png){#fig:p3_5 width="90%"}
...
strings](phan3_image6.png){#fig:p3_6 width="90%"}

![Network strings grep --- token=%s&guid=%s, HTTP headers và endpoint
API](phan3_image7.png){#fig:p3_7 width="90%"}

![Ghidra --- evidence loopback constant 0x0100007f trong function
0x08050910](phan3_image8.png){#fig:p3_8 width="90%"}

![Ghidra --- port bytes 0x46d1 trong socket
setup](phan3_image9.png){#fig:p3_9 width="90%"}

![Ghidra --- rename FUN_080485de thành
command_handler_table_init_candidate](phan3_image10.png){#fig:p3_10
width="90%"}

![Ghidra --- rename FUN_08048588 thành
register_command_handler_candidate](phan3_image11.png){#fig:p3_11
width="90%"}

![Ghidra comment --- command ID 0x32 maps to
http_flood_sender](phan3_image12.png){#fig:p3_12 width="90%"}

![SHA256 hash --- xác nhận đúng mẫu trước khi phân
tích](phan3_image13.png){#fig:p3_13 width="90%"}

![Lệnh file --- xác nhận ELF 32-bit LSB executable, Intel 80386,
statically linked, stripped](phan3_image14.png){#fig:p3_14 width="90%"}

![strings -a --- xuất chuỗi ban đầu từ ELF
binary](phan3_image15.png){#fig:p3_15 width="90%"}
...
/proc/net/tcp](phan3_image16.png){#fig:p3_16 width="90%"}

![Credential search output --- các hit là endpoint/string, không phải
user:pass plaintext](phan3_image17.png){#fig:p3_17 width="90%"}

![Ghidra Defined Strings --- reference tại
/admin](phan3_image18.png){#fig:p3_18 width="90%"}

![Ghidra Defined Strings --- reference tại
/admin/login](phan3_image19.png){#fig:p3_19 width="90%"}

![Ghidra Defined Strings --- reference tại
/admin/dashboard](phan3_image20.png){#fig:p3_20 width="90%"}

![Ghidra References --- format string HTTP request với
Host/User-Agent](phan3_image21.png){#fig:p3_21 width="90%"}

![Ghidra Defined Strings --- reference tại
/api/v1/users](phan3_image22.png){#fig:p3_22 width="90%"}

![Ghidra Defined Strings --- reference tại
/status](phan3_image23.png){#fig:p3_23 width="90%"}

![Ghidra --- rename hàm tại 0x08051a32 thành
socket_wrapper](phan3_image24.png){#fig:p3_24 width="90%"}
...
signal_setup](phan3_image25.png){#fig:p3_25 width="90%"}

![Ghidra --- rename hàm tại 0x08052d63 thành
printf_wrapper](phan3_image26.png){#fig:p3_26 width="90%"}

![Ghidra --- rename hàm tại 0x080535dd thành
write_wrapper](phan3_image27.png){#fig:p3_27 width="90%"}

![Ghidra --- rename hàm tại 0x08054c21 thành
send_wrapper](phan3_image28.png){#fig:p3_28 width="90%"}

![Ghidra --- rename hàm tại 0x080514d1 thành
gen_random_string](phan3_image29.png){#fig:p3_29 width="90%"}

![Ghidra --- rename hàm tại 0x08050aa6 thành
init_rng](phan3_image30.png){#fig:p3_30 width="90%"}

![Ghidra --- rename hàm tại 0x08048286 thành
build_c2_post_data](phan3_image31.png){#fig:p3_31 width="90%"}

![Ghidra annotation --- XOR result được ghi lại vào memory, dấu hiệu
encode/decode loop](phan3_image32.png){#fig:p3_32 width="90%"}
...
rc4_like_decoder_candidate](phan3_image33.png){#fig:p3_33 width="90%"}

![Ghidra search --- không tìm thấy immediate
0xDEADBEEF](phan3_image34.png){#fig:p3_34 width="90%"}

![Ghidra search --- không tìm thấy byte sequence EF BE AD
DE](phan3_image35.png){#fig:p3_35 width="90%"}

![Ghidra search --- không tìm thấy byte sequence DE AD BE
EF](phan3_image36.png){#fig:p3_36 width="90%"}

![XOR helper --- chạy thử key 0xDEADBEEF, effective byte
0x22](phan3_image37.png){#fig:p3_37 width="90%"}

![XOR helper result --- output decode không tạo credential/C2 table có
nghĩa](phan3_image38.png){#fig:p3_38 width="90%"}

![Ghidra References --- token=%s&guid=%s có 2
locations](phan3_image39.png){#fig:p3_39 width="90%"}

![Ghidra References --- địa chỉ/string 08057aaf không có
location](phan3_image40.png){#fig:p3_40 width="90%"}

![Ghidra References --- GET / HTTP/1.1 Host có 2
locations](phan3_image41.png){#fig:p3_41 width="90%"}

![Ghidra References --- kiểm tra lại GET / HTTP/1.1 Host trong Defined
Strings](phan3_image42.png){#fig:p3_42 width="90%"}

![Ghidra References --- format string "%s /%s HTTP/1.1 Host: %s
User-Agent" có 2 locations](phan3_image43.png){#fig:p3_43 width="90%"}

![Ghidra References --- Mozilla/5.0 user-agent có 1
location](phan3_image44.png){#fig:p3_44 width="90%"}

![Ghidra References --- HTTP request format string có DATA
offcut](phan3_image45.png){#fig:p3_45 width="90%"}
...
127.0.0.1](phan3_image46.png){#fig:p3_46 width="90%"}

![Ghidra --- network-order 0x46d1 tương ứng port
18129](phan3_image47.png){#fig:p3_47 width="90%"}

![Ghidra --- network-order 0x3500 tương ứng port
53](phan3_image48.png){#fig:p3_48 width="90%"}
...
ICMP](phan4_image1.png){#fig:p4_1 width="90%"}

### IPv4 Conversations

![IPv4 Conversations --- traffic tập trung giữa 10.10.10.20 và
10.10.10.10](phan4_image2.png){#fig:p4_2 width="90%"}
...
39419](phan4_image3.png){#fig:p4_3 width="90%"}

![Wireshark Conversations TCP --- nhiều phiên 10.10.10.20 tới port
443](phan4_image4.png){#fig:p4_4 width="90%"}

![Lọc tcp.port == 39419 --- SYN bị từ chối bằng RST,
ACK](phan4_image5.png){#fig:p4_5 width="90%"}
...
Data](phan4_image6.png){#fig:p4_6 width="90%"}
...
53](phan4_image7.png){#fig:p4_7 width="90%"}
...
record](phan4_image8.png){#fig:p4_8 width="90%"}
...
10.10.10.10](phan4_image9.png){#fig:p4_9 width="90%"}
...
bại](phan4_image10.png){#fig:p4_10 width="90%"}
...
Data](phan4_image11.png){#fig:p4_11 width="90%"}
...
OK](phan4_image12.png){#fig:p4_12 width="90%"}
